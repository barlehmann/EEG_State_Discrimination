 ...
 "cells": [
  {
   ...
   "outputs": [],
   "source": [
    "**************Feature Extraction Class and Methods**************"
   ]
  },
  {
   "cell_type": "code",
   ...
   "source": [
    ...
    "    def __init__(self, seconds_per_sample, filepath=r\"C:\\Users\\barle\\Downloads/eeg_dataEC.edf\"):\n",
    "        #For the filepath, it is for the raw data - one can use this as guideline for filepath on a windows pc: raw = mne.io.read_raw_edf(r\"C:\\Users\\barle\\Downloads/eeg_dataEC.edf\") \n",
    "        \n",
    ...
    "a = preprocess_raw(4, filepath=r\"C:\\Users\\barle\\Downloads/eeg_dataEC.edf\")        "
   ]
  },
  {
   "cell_type": "code",
   ...
   "outputs": [],
   "source": [
    "MACHINE LEARNING CLASSES AND METHODS"
   ]
  },
  {
   "cell_type": "code",
